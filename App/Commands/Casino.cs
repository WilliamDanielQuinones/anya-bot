...
public class Casino : ModuleBase<SocketCommandContext>
{
    ...
    private readonly ulong[] casinoListMessageIds = new ulong[] { 967544085462253639, 967544086208864316, 967544086733144114 };
    ...
    public async Task CasinoHelpCommand()
    {
        ...
        embed.AddField("How to Play", "𝟥 𝖳𝖨𝖢𝖪𝖤𝖳𝖲 𝖳𝖮 𝖯𝖫𝖠𝖸 | Kmt Dann IN THE #card-casino-floor channel | USE COMMAND `d!casinoroll` | 𝖫𝖮𝖢𝖪-𝖨𝖭 𝟥 𝖳𝖨𝖢𝖪𝖤𝖳𝖲​​​​​", true);
