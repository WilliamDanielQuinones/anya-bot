...
public class Casino : ModuleBase<SocketCommandContext>
{
    ...
    private readonly ulong[] casinoListMessageIds = new ulong[] { 967655260921409546, 967655261806411789, 967655263316353084 };
    ...
    public async Task CasinoHelpCommand()
    {
        ...
        embed.AddField("How to Play", "𝟥 𝖳𝖨𝖢𝖪𝖤𝖳𝖲 𝖳𝖮 𝖯𝖫𝖠𝖸 | Kmt Dann IN THE #card-casino-floor channel | USE COMMAND `d!casinoroll` | 𝖫𝖮𝖢𝖪-𝖨𝖭 𝟥 𝖳𝖨𝖢𝖪𝖤𝖳𝖲​​​​​ | CARD LIST IN #card-casino-floor", true);
